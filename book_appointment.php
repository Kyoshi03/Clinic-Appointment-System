...
$additionalStyles = '
    ...
    .doctor-event.is-full { background:#fff0f1; color:#8f1d2a; border-color:#efc3c8; border-left-color:#d93045; }
    .doctor-event.is-full .availability-label,.doctor-event.is-full .availability-doctor,.doctor-event.is-full .availability-count { color:#9f1c2b; }
    ...
    .capacity-event.is-full { background:#fff0f1; color:#a61b2b; border-color:#f2c2c8; border-left-color:#d93045; }
    ...
    .cal-day.is-fully-booked { background:#fff7f7; box-shadow:inset 0 3px 0 #d93045; }
    .cal-day.is-fully-booked .cal-date-number { background:#ffe3e6; color:#a61b2b; }
    ...
    .capacity-doctor-row.is-full { border-color:#f1c4ca; background:#fff7f8; }
                        ...
                        <div class="mini-calendar" aria-label="Appointment calendar">
                            ...
                            <div class="cal-grid" id="appointmentCalendar">
                                ...
                                <?php for ($day = 1; $day <= $calendarDaysInMonth; $day++): ?>
                                    ...
                                    $labCapacityRows = [[
                                        'doctor' => 'Laboratory appointment slots',
                                        'specialty' => $bk['type'] === 'package' ? 'Package deals' : 'Individual laboratory tests',
                                        'booked' => $labBooked,
                                    ...
                                    <button
                                        ...
                                        data-selectable="<?php echo $capacityFull ? '0' : '1'; ?>"
                                        data-capacity-date="<?php echo htmlspecialchars($dateValue); ?>"
